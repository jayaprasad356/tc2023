...
class TempleinfoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var name = intent.getStringExtra(com.telugucalendar.telugupanchangamr.helper.Constant.TEMPLEINFO_NAME)
        var location = intent.getStringExtra(com.telugucalendar.telugupanchangamr.helper.Constant.TEMPLEINFO_LOCATION)
        var description = intent.getStringExtra(com.telugucalendar.telugupanchangamr.helper.Constant.TEMPLEINFO_DESCRIPTION)
        var image = intent.getStringExtra(com.telugucalendar.telugupanchangamr.helper.Constant.TEMPLEINFO_IMAGE)
