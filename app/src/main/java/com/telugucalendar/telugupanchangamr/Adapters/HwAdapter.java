...
import com.telugucalendar.telugupanchangamr.Fragments.panchangamFrag;
...
public class HwAdapter extends BaseAdapter {
    ...
    public void refreshDays() {
        ...
        else if (month.get(GregorianCalendar.YEAR) == 2024){


            if(month.get(GregorianCalendar.MONTH) == 2 || month.get(GregorianCalendar.MONTH) == 5)
            {
                mnthlength = 6 * 7;
