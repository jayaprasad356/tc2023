...
class NavagrahluFragment : Fragment() {

    private var binding : FragmentNavagrahluBinding? = null;
    ...
    override fun onCreateView(
        ...
        binding = FragmentNavagrahluBinding.inflate(layoutInflater,container,false)
    ...
    private fun grahalu() {
            ...
            if (result) {
                try {
                    ...
                    if (jsonObject.getBoolean(Constant.SUCCESS)) {
                        ...
                        val files = jsonarray2.getJSONArray(Constant.NAVAGRAHALU_TAB_VARIANT)
                        val g = Gson()
        ...
        }, activity, Constant.NAVAGRAHALU_LIST, params, true)
    }
