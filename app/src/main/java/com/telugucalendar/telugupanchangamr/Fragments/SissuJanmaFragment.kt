...
import com.telugucalendar.telugupanchangamr.Adapters.SissujunmaAdapter
import com.telugucalendar.telugupanchangamr.Model.Sissujanma
...
class SissuJanmaFragment : Fragment() {
    ...
    private fun sissujanma() {
        ...
        params[com.telugucalendar.telugupanchangamr.helper.Constant.SISSU_JANMA] = "1"
            ...
            if (result) {
                try {
                    ...
                    if (jsonObject.getBoolean(com.telugucalendar.telugupanchangamr.helper.Constant.SUCCESS)) {
                        val jsonArray: JSONArray = jsonObject.getJSONArray(com.telugucalendar.telugupanchangamr.helper.Constant.SISSU_JANMA_LIST)
                        val g = Gson()
