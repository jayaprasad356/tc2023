...
import com.telugupanchangam.telugucalender.databinding.FragmentRudhrakhaluBinding
import org.json.JSONArray
import org.json.JSONObject


class RudhrakhaluFragment : Fragment() {
    private var binding : FragmentRudhrakhaluBinding? = null;
    ...
    override fun onCreateView(
        ...
        binding = FragmentRudhrakhaluBinding.inflate(layoutInflater,container,false)
    ...
    private fun grahalu() {
            ...
            if (result) {
                try {
                    ...
                    if (jsonObject.getBoolean(Constant.SUCCESS)) {
                        ...
                        val files = jsonarray2.getJSONArray(Constant.RUDHRAKSHA_TAB_VARIANT)
                        val g = Gson()
        ...
        }, activity, Constant.RUDHRAKSHA_LIST, params, true)
    }
